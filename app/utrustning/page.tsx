...
const equipment = [
  {
    ...
    icon: (
      <svg viewBox="0 0 72 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-12">
        ...
        <circle cx="8" cy="51" r="4" fill="#1c3d2a" stroke="#d97706" strokeWidth="1.5" />
        <circle cx="34" cy="51" r="4" fill="#1c3d2a" stroke="#d97706" strokeWidth="1.5" />
        {/* Body / cab */}
        <rect x="4" y="30" width="32" height="18" rx="3" fill="#1c3d2a" />
        <rect x="8" y="33" width="14" height="10" rx="2" fill="#4a8c62" />
        {/* Boom arm */}
        <path d="M34 34 L56 18" stroke="#1c3d2a" strokeWidth="5" strokeLinecap="round" />
        {/* Stick */}
        <path d="M56 18 L66 30" stroke="#2d5c3e" strokeWidth="4" strokeLinecap="round" />
        {/* Bucket (grävskopa) */}
        <path d="M63 29 Q70 32 68 40 L60 38 Z" fill="#1c3d2a" />
        {/* Teeth */}
        <line x1="63" y1="39" x2="62" y2="43" stroke="#d97706" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="66" y1="39" x2="66" y2="43" stroke="#d97706" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-12 h-12">
        ...
        <line x1="16" y1="56" x2="16" y2="60" stroke="#d97706" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="24" y1="56" x2="24" y2="60" stroke="#d97706" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="32" y1="56" x2="32" y2="60" stroke="#d97706" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="40" y1="56" x2="40" y2="60" stroke="#d97706" strokeWidth="1.5" strokeLinecap="round" />
        <line x1="48" y1="56" x2="48" y2="60" stroke="#d97706" strokeWidth="1.5" strokeLinecap="round" />
        {/* Engine block */}
        ...
        {/* Handle bar */}
        <path d="M22 28 L18 10 M42 28 L46 10" stroke="#1c3d2a" strokeWidth="3" strokeLinecap="round" />
        <path d="M14 10 L50 10" stroke="#1c3d2a" strokeWidth="3" strokeLinecap="round" />
  ...
  },
  {
    ...
    useCases: ["Fasadrenovering", "Målning & puts", "Takarbeten", "Fönsterbyte"],
    icon: (
      <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-12 h-12">
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 72 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-14 h-12">
        ...
        {/* Kåp roof ridge */}
        <path d="M4 16 Q36 8 68 16" stroke="#1c3d2a" strokeWidth="2" fill="#1c3d2a" />
        {/* Rear door lines */}
        <line x1="36" y1="19" x2="36" y2="41" stroke="#1c3d2a" strokeWidth="1.5" />
    ...
    <div className="flex-1 bg-[#f5f2ec]">
      ...
      <div className="bg-[#1c3d2a] py-10 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white">Utrustning</h1>
          <p className="text-white/60 mt-2 max-w-xl">
            Vi har ett litet men välskött sortiment. Ring oss så hittar vi rätt lösning för ditt projekt.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
              ...
              <div className="p-6 flex gap-4 items-start flex-1">
                ...
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    <h2 className="text-lg font-bold text-[#1c3d2a]">{item.name}</h2>
                    {item.tentative && (
                  ...
                  <p className="text-[#3a3a35] text-sm mt-2 leading-relaxed">{item.description}</p>
                </div>
              </div>
        ...
        <div className="mt-10 bg-[#1c3d2a] rounded-xl px-6 py-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-white/60 text-sm mt-1">Ring Emanuel direkt — vi svarar snabbt.</p>
          </div>
          <a
